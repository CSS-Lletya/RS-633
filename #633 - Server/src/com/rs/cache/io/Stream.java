...
public abstract class Stream {
	...
	private final int readInt() {
		offset += 4;
		return ((((Stream) this).buffer[offset - 1] & 0xff)
				+ (~0xffffff & ((Stream) this).buffer[offset - 4] << 24) - (-(0xff0000 & ((Stream) this).buffer[offset - 3] << 16) + -((((Stream) this).buffer[offset - 2] & 0xff) << 8)));
	}
