...
public class CommendationExchange {//1875 TODO
	...
	if (componentId == 68) {
		...
		player.getPackets().sendGameMessage("You need a mining level of 25 in order to purchase a herblore pack.");
		return;
		...
		player.getPackets().sendGameMessage("You need a farming level of 25 in order to purchase a herblore pack.");
		return;
	    } else if (!exchangeCommendation(player, 15))
		return;
