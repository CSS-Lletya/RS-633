...
public class NomadsRequiem extends Controller {
	...
	WorldTasksManager.schedule(new WorldTask() {
	    ...
	    public void run() {
		if (stage == 1) {
		    player.getPackets().sendCameraPos(Cutscene.getX(player, getBaseX() + 19), Cutscene.getY(player, getBaseY() + 14), 3000);
		    player.getPackets().sendCameraLook(Cutscene.getX(player, getBaseX() + 17), Cutscene.getY(player, getBaseY() + 5), 2000);
		    player.setRun(false);
		    player.getPackets().sendCameraPos(Cutscene.getX(player, getBaseX() + 23), Cutscene.getY(player, getBaseY() + 8), 2500, 4, 4);
		    player.getPackets().sendCameraLook(Cutscene.getX(player, getBaseX() + 17), Cutscene.getY(player, getBaseY() + 14), 2000, 2, 2);
		    player.addWalkSteps(getBaseX() + 16, getBaseY() + 19, -1, false);
		} else if (stage == 10) {
		    player.getPackets().sendCameraPos(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 8), 2500, 4, 4);
		    player.getPackets().sendCameraLook(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 14), 2000, 2, 2);
		} else if (stage == 15) {
		    player.getPackets().sendCameraLook(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 21), 800, 6, 6);
		    player.getPackets().sendCameraPos(Cutscene.getX(player, getBaseX() + 16), Cutscene.getY(player, getBaseY() + 14), 1800, 6, 6);
		} else if (stage == 20) {
	...
	CoresManager.slowExecutor.execute(new Runnable() {
		...
		try {
		    ...
		    currentPart = part;
		    MapBuilder.copyAllPlanesMap(part.chunkX, part.chunkY, mapBaseChunks[0], mapBaseChunks[1], part.sizeX, part.sizeY);
