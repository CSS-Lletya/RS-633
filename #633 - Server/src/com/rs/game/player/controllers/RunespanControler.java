...
public class RunespanControler extends Controller {
	...
	switch (npc.getId()) {
		...
		player.getInventory().addItem(new Item(24227, 25 - player.getInventory().getAmountOf(24227)));
		return false;
	    case 15435:
	    case 15434:
	    case 15433:
