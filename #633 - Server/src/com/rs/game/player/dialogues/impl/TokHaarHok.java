...
public class TokHaarHok extends Dialogue {
	...
	switch (type) {
		...
		switch (stage) {
		    case -1:
			stage = 0;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "Let's fight.", "I'd like to speak more about you and your kind.");
			break;
		    case 0:
			switch (componentId) {
			    case OPTION_1:
		    ...
		    case 1:
			stage = 2;
			sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "No, let's just fight.", "What do I get if I beat you?", "What are the rules?");
			break;
		    case 2:
			switch (componentId) {
			    case OPTION_1:
